export const translations = {
  es: {
    ...
    saved: {
      save: "Guardar ruta",
      saving: "Guardando...",
      success: "Ruta guardada. Codigo para el huesped:",
      loaded: "Ruta cargada",
    ...
    guest: {
      eyebrow: "Acceso de huesped",
      title: "Cargar una ruta asignada",
      description: "Introduce el codigo facilitado por el hotel para ver la ruta en el mapa.",
  ...
  en: {
    ...
    saved: {
      save: "Save route",
      saving: "Saving...",
      success: "Route saved. Guest code:",
      loaded: "Route loaded",
    ...
    guest: {
      ...
      description: "Enter the code provided by the hotel to view the route on the map.",
